...
namespace BNO055_Firmware_Update_Utility
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            this.Text = "BNO055 Firmware Update Utility (UART version) - Ready to upload file: " + fn;
        ...
        private bool SendCommands(byte[] data)
        {
            ...
            if (receivedAcknowledgement != (byte)115)
            {
                ...
                MessageBox.Show("CRC failed during transmission", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
